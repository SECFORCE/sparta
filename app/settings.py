...
class AppSettings():
	...
	def createDefaultSettings(self):
		...
		self.actions.setValue("dirb", ["Run dirb (http)", "dirb http://[IP]:[PORT] -S -o \"[OUTPUT].txt\"", "http,https,ssl,soap,http-proxy,http-alt"])
		self.actions.setValue("dirbs", ["Run dirb (https)", "dirb https://[IP]:[PORT] -S -o \"[OUTPUT].txt\"", "http,https,ssl,soap,http-proxy,http-alt"])		
